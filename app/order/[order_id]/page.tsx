    ...
    <MantineProvider>
      <div className="p-6 border border-gray-200 rounded-3xl w-full group transition-all duration-500 hover:border-gray-400 ">
        <Box className="shadow-sm my-5">
          ...
          <Group className="flex flex-row justify-between border-b">
          ...
          {order.items.map((item) => (
            <div className="flex items-center justify-between gap-4 mb-5">
              <div className="flex flex-col">
                <p className="font-normal text-lg leading-8 text-black transition-all duration-500 group-hover:text-gray-700">{item.item}</p>
                <p className="font-noraml text-lg leading-8 text-black transition-all duration-500 group-hover:text-gray-700">數量: {item.quantity}</p>
              </div>
